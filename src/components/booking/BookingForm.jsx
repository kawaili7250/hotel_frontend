...
const BookingForm = () => {
  ...
  const calculatePayment = () => {
    ...
    return price * differentDays;
  }

  const isGuestCountValid = () => {
    const adultCount = parseInt(booking.numOfAdults);
    const childrenCount = parseInt(booking.numOfChilds);
  ...
  const isCheckOutDateValid = () => {
    if (!moment(booking.checkOutDate).isSameOrAfter(moment(booking.checkInDate))) {
      setErrorMessage("Check-out date should be later than Check-in date");
      return false;
    } else {
      setErrorMessage("");
      return true;
              ...
              <Form noValidate validated={isValidated} onSubmit={handleSubmit}>
                ...
                <fieldset>
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      <Form.Label htmlFor="numOfChilds" className="hotel-color">Children:</Form.Label>
                      <FormControl
                        required
                        type="number"
                        id="numOfChilds"
                        name="numOfChilds"
                        value={booking.numOfChilds}
                        placeholder="0"
                        min={0}
                        onChange={handleInputChange}/>
                      <Form.Control.Feedback type="invalid">
